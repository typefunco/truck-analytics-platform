...
func InitRouter() {
	...
	// Tractors
	server.Handle("GET", "/9m2023tractors4x2", september2024.NineMonth2023Tractors4x2)
	server.Handle("GET", "/9m2023tractors6x4", september2024.NineMonth2023Tractors6x4)

	// Dumpers
	server.Handle("GET", "/9m2023dumpers6x4", september2024.NineMonth2023Dumpers6x4)
	server.Handle("GET", "/9m2023dumpers8x4", september2024.NineMonth2023Dumpers8x4)
